  ...
  return (
    <div className="text-white custom-gradient mt-[-4rem] relative">
      ...
      <section className="relative w-full top-[0rem] h-screen mx-2 border-white border-8 border-t-0 rounded-3xl rounded-t-none rounded-bl-none bg-white">
        ...
        />
        <div className="absolute w-1/3 top-[30%] md:top-[40%] ml-4 md:ml-8 lg:right-[10%] flex flex-col space-y-4 md:space-y-8">
          ...
          Various types and grades of Steel structures, Pressure vessels, Boiler tubes parts, economizers, Underground mine Shaft sinking stage and steel components plants fabrication services.          </p>
