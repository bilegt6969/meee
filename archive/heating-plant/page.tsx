    ...
    <div className="text-white custom-gradient mt-[-4rem] relative">
      ...
      <section className="relative top-[0rem] h-screen mx-2 border-white border-8 border-t-0 rounded-3xl rounded-t-none rounded-bl-none bg-white">
        ...
        <div className="absolute top-[30%] md:top-[40%] ml-4 md:ml-8 lg:right-[10%] flex flex-col space-y-4 md:space-y-8">
          ...
          Дулааны байгууламж, Төвлөрсөн Дулааны Станц, Өндөр болон Нам даралтын зуухнууд, Дулаан дамжуулах системийн ашиглалт болон засварын үйлчилгээ мөн Цахилгаан, Хэмжүүр болон Удирдлагын системүүд.
          </p>
      ...
      <section className="flex flex-col md:flex-row space-x-0 md:space-x-2 mt-2">
        ...
        <Image
          ...
          className="w-full md:w-1/2 border-white rounded-3xl border-8 ml-2"
          src="/1.png"
        />
      </section>

      {/* Electric and Switch Systems Section */}
      <section className="flex mx-2 flex-col md:flex-row mt-2 space-x-0">
        <div className="md:w-1/2 border-[#f0f0f0] bg-[#f0f0f0] rounded-3xl rounded-bl-none border-8">
        <Image
          width={700}
          height={700}
        ...
        <div className="bevel8"></div>
        
        <div className="rounded-bl-3xl p-4 md:p-8 w-full md:w-1/2 text-left">
          <h1 className="text-2xl md:text-4xl font-extrabold mb-4">ELECTRIC AND SWITCH SYSTEMS</h1>
          <p className="text-base md:text-xl leading-7 font-thin">
            Industrial and energy supply electrical equipment...
          </p>
          <ul className="mt-4 space-y-2 text-base md:text-xl font-thin">
            <li className="flex items-center">
              <CheckIcon className="mr-2" /> Transformer station...
            </li>
            <li className="flex items-center">
              <CheckIcon className="mr-2" /> Medium voltage systems...
            </li>
          </ul>
        </div>
      ...
      <section className="mx-2 pt-9 bg-[#f0f0f0] rounded-tr-3xl">
      ...
      <div className="pb-36 bg-blue-800"></div>
    </div>
  );
}
