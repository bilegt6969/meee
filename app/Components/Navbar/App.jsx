...
const Navbar = () => {
  ...
  return (
    <div
      className={`z-[4000] sticky top-0 transition-colors duration-300 ${navBackground ? "bg-white shadow-md" : "bg-transparent"}`}
    >
          ...
          <div className="hidden sm:ml-6 sm:hidden lg:flex sm:items-center">
            <Dropdown>
              ...
              <DropdownMenu aria-label="Static Actions">
                <DropdownItem href="/Service" key="edit">
                  Mining
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
              ...
              <DropdownTrigger>
                <Button variant="">
                  <GlobeAsiaAustraliaIcon
                    className={`h-6 w-6 ${navBackground ? "text-black" : "text-white"}`}
                  />
                  <p
                    className={`${navBackground ? "text-black" : "text-white"}`}
                  >
