...
function Footer() {
  return (
    <div>
      <footer className="w-full border-t mt-[9rem]">
              ...
              <ul className="text-sm  transition-all duration-500">
                ...
                <li className="mb-6">
                  <a
                    ...
                    className=" text-gray-600 hover:text-gray-900"
                  >
                    Engineering and technical serive
                  </a>
                </li>
                
              </ul>
            </div>
            <div className="lg:mx-auto text-left justify-end right-0">
            <h4 className="text-lg text-gray-900 font-bold mb-7">
                Contact Us
              </h4>
              <ul className="text-sm  transition-all duration-500">
                ...
                <li className="mb-6 flex items-center  space-x-2">
                <EnvelopeIcon className="size-6 text-blue-800" />
                ...
                <li className="mb-6 flex items-center  space-x-2">
                <MapPinIcon className="size-6 text-blue-800" />
                  <a
                    href="javascript:;"
                    className=" text-gray-600 hover:text-gray-900"
                  >
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-gray-500 ">
                ©<a href="https://pagedone.io/">Gerege</a> 2024, All rights
                reserved.
              </span>
