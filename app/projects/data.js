const projects_Data = [
    {
      ...
      title: "Shaft #1 Headframe",
      titleDescription: "Fit-Out Project",
      location: "Mongolia",
      date: "2024",
      img: "/bg.jpg", //image of the projects page
      alt: "Shaft #1 Headframe",
      slides: [
        { id: 1, src: "/img-111.jpg", alt: "Slide 1" },
        { id: 2, src: "/img-bg-1.png", alt: "Slide 2" },
        { id: 3, src: "/img-111.jpg", alt: "Slide 3" },
      ],
      body: {
        title: "Shaft #1 Headframe",
    ...
    // Add more unique project objects similarly
  ];
